...
public interface ITodoService
{
    ...
    Task<Result<TodoViewModel>> CreateTodoAsync(TodoViewModel model, CancellationToken cancellationToken = default);
    Task<Result<TodoViewModel>> UpdateTodoAsync(long id, TodoViewModel model, CancellationToken cancellationToken = default);
